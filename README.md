...
Создать галерею с возможностью клика по ее элементам и просмотра полноразмерного
изображения в модальном окне с использованием упаковщика для веб-приложений
Parcel.

Превью результата: [по ссылке](https://take.ms/ZvBD0E) ![Превью](preview.jpg)
...
- В папке [src](./src) стартовые файлы проекта с базовой разметкой и готовыми
  стилями.
